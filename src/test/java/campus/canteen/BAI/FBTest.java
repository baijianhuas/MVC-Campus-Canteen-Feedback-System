...
import campus.canteen.BAI.feed.Fb;
import campus.canteen.entity.FBStatusEnum;
...
public class FBTest extends BaseFB {
    ...
    public void queryBlog() {
        P.out(fb.listFB(1, FBStatusEnum.PRIVATE.getCode()));
    }

    @Test
    public void queryBlogWithLimit() {
        P.out(fb.listFBWithLimit(2, FBStatusEnum.PUBLIC.getCode(), 0, 1000));
    }
