...
public interface ProfileService {
     ...
     * @return 查询结果
     */
    ResultBean<List<CollectFBListItemDTO>> listCollectBlog(int userId, int categoryId,
     ...
     * @return 执行结果，新增记录id
     */
    ResultBean<Integer> insertCollectBlog(int userId, int feedbackId, int categoryId, int authorId, String reason);
